...
const MeuComponente = withAsyncImport(() => import('./MeuComponente/meuComponente'));
const MeuComponente2 = withAsyncImport(() => import('./MeuComponente2/meuComponente2'));
...
MapTo("reactapp/components/meu-componente2")(MeuComponente2);
